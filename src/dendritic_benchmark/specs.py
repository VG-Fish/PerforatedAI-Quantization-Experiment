...
CONDITION_SPECS: list[ConditionSpec] = [
    ...
    ConditionSpec("dendrites_pruned_q8", "+Dend + Prune + Q8", "dendrites_pruned", 8, "int", True, False, False),
    ConditionSpec("dendrites_pruned_q4", "+Dend + Prune + Q4", "dendrites_pruned", 4, "int", True, False, False),
